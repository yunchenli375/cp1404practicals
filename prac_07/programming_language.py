...
class ProgrammingLanguage:
    ...
    def __repr__(self):
        ...
        return f"{self.name}, {self.typing} Typing, Reflection={self.reflection}, First appeared in {self.year}, Pointer arithmetic {'' if self.pointer_arithmetic else 'un'}supported"
